        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                <div class="row">
                    ...
                    <div class="col-xs-2 col-sm-2 col-md-2">
                        <a href="${contextPath}/logout"><img src="${contextPath}/resources/img/logout.png" class="pull-right search_icon" ></a>        
                    </div>
                </div>
            </div>
        </nav>
                ...
                <div class="home_alignment">
                    ...
                    <div class="row">
                        ...
                        <form:form id="searchForm" name="searchForm"
                               action="${contextPath}/clients/lastName" method="get" modelAttribute="clientSearchRequest" onsubmit="return(validate());">
                                  ...
                                  <div class="form-group">
                                    <div class="col-xs-12 col-sm-4 col-md-4 pull-right">
                                        <button type="submit" data-role="button" data-transition="slide" class="btn btn-lg btn-primary btn-block">Go</button>
